...
<body>
	...
	<div class="container">
		...
		<div class="product-grid">
			...
			String[][] products = { { "1", "r5600", "msib550", "rtx4060ti", "16gb", "1tb", "0gb", "x" },
			...
			%>
			<a
				href="product.jsp?pic=<%=pic%>&cpu=<%=cpu%>&mainboard=<%=mainboard%>&gpu=<%=gpu%>&ram=<%=ram%>&ssd=<%=ssd%>&hdd=<%=hdd%>&os=<%=os%>"
				class="product-link">
				<div class="product">
					...
					<div class="product-details">
						...
						<p>
							...
							<%=ssd%></p>
						<div>
							Preis: €<%=String.format("%.2f", price)%></div>
					</div>
				</div>
			</a>
			<%

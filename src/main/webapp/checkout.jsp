						...
						<div class="product-container">
							<div class="checkout-form form-group">
								<label for="street">Straße</label> <input type="text"
									id="street" name="street" placeholder="Straße" required>
							</div>
							<div class="checkout-form form-group">
								<label for="house-number">Hausnummer</label> <input
									type="number" id="house-number" name="house-number"
									placeholder="Hausnummer" required>
							</div>
						</div>
						<div class="product-container">
							<div class="checkout-form form-group">
								<label for="city">Stadt</label> <input type="text" id="city"
									name="city" placeholder="Stadt" required>
							</div>
							<div class="checkout-form form-group">
								<label for="postal-code">Postleitzahl</label> <input
									type="number" id="postal-code" name="postal-code"
									placeholder="Postleitzahl" required>
							</div>
						</div>
						<div class="form-group">
							<label for="country">Land</label> <input type="text" id="country"
								name="country" placeholder="Land" required>
						</div>
					</form>
				</div>
				...
				<div class="checkout-form">
					...
					<div class="form-group">
						<label for="card-number">Kreditkartennummer</label> <input
							type="number" id="card-number" name="card-number"
				...
				<div class="order-summary">
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<td class="total" colspan="3">Gesamtpreis:
									${config.getTotalPrice()} €</td>
							</tr>
						</tbody>
					</table>

...
<head>
    ...
    <title>Produktdetails - Computer Konfigurator Shop</title>
    <link rel="stylesheet" href="css/ProduktSytles.css">
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="index.jsp#produkte">Produkte</a></li>
                <li><a href="index.jsp#konfigurator">Konfigurator</a></li>
                <li><a href="index.jsp#kontakt">Kontakt</a></li>
            </ul>
        </nav>
    </header>

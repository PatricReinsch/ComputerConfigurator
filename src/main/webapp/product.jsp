			...
			<div class="product-container">
				...
				<div class="configurator">
					...
					<form action="config" method="post">
						...
						<!-- Mainboard models -->
						<div class="form-group">
							<label for="mainboard">Mainboard:</label> <select id="mainboard"
								name="mainboard">
						...
						<!-- GPU models -->
						<div class="form-group">
							<label for="gpu">Grafikkarte:</label> <select id="gpu" name="gpu">
						...
						<!-- RAM models -->
						<div class="form-group">
							<label for="ram">Arbeitsspeicher:</label> <select id="ram"
								name="ram">
						...
						<!-- SSD models -->
						<div class="form-group">
							<label for="ssd">SSD:</label> <select id="ssd" name="ssd">
						...
						<!-- HDD models -->
						<div class="form-group">
							<label for="hdd">HDD:</label> <select id="hdd" name="hdd">
						...
						<!-- OS models -->
						<div class="form-group">
							<label for="os">Betriebssystem:</label> <select id="os" name="os">
